...
Page({
  ...
  input_tips: function (e) {
    ...
    wx.request({
      url: 'https://test.hivetech.cn/hkc/job/Home/Student/input_tips',
      method: 'GET',
      data: {},
      success: function (res) {
        ...
        newhistoryList.push(res.data)

        newhistoryList[0].forEach(function (e) {
          var company = e.company;
          if (company.indexOf(inputValue) != -1) {
            temp.push({ 'Company': company });
          }
        });
        if (inputValue == '') {
          temp = []
